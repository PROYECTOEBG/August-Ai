...
if (!img) return conn.reply(m.chat, `🐉 *_Responda a una imagen o video._*`, m, rcanal)
...
else return conn.reply(m.chat, '⛄ *_Oops!_Responda a una imagen o video._*', m, rcanal)
